const SendTestEmail = (form,loading, popUpContainer,popUpContent,popUpIcon,popUpMessage,popUpConfirm) => {
  ...
  form.addEventListener("submit", async (event) => {
    ...
    const response = await fiber.post("/admin/io.php/test/email", data);
  ...
  const popUpClose = document.querySelector(".dismiss-popup.test-email");
